...
import (
	...
	pg "github.com/code-payments/ocp-server/pkg/database/postgres"
	...
	cvm_ram "github.com/code-payments/ocp-server/pkg/code/data/cvm/ram"
	cvm_storage "github.com/code-payments/ocp-server/pkg/code/data/cvm/storage"
	...
	account_memory_client "github.com/code-payments/ocp-server/pkg/code/data/account/memory"
	action_memory_client "github.com/code-payments/ocp-server/pkg/code/data/action/memory"
	balance_memory_client "github.com/code-payments/ocp-server/pkg/code/data/balance/memory"
	currency_memory_client "github.com/code-payments/ocp-server/pkg/code/data/currency/memory"
	cvm_ram_memory_client "github.com/code-payments/ocp-server/pkg/code/data/cvm/ram/memory"
	cvm_storage_memory_client "github.com/code-payments/ocp-server/pkg/code/data/cvm/storage/memory"
	deposit_memory_client "github.com/code-payments/ocp-server/pkg/code/data/deposit/memory"
	fulfillment_memory_client "github.com/code-payments/ocp-server/pkg/code/data/fulfillment/memory"
	intent_memory_client "github.com/code-payments/ocp-server/pkg/code/data/intent/memory"
	messaging_memory_client "github.com/code-payments/ocp-server/pkg/code/data/messaging/memory"
	nonce_memory_client "github.com/code-payments/ocp-server/pkg/code/data/nonce/memory"
	rendezvous_memory_client "github.com/code-payments/ocp-server/pkg/code/data/rendezvous/memory"
	swap_memory_client "github.com/code-payments/ocp-server/pkg/code/data/swap/memory"
	timelock_memory_client "github.com/code-payments/ocp-server/pkg/code/data/timelock/memory"
	transaction_memory_client "github.com/code-payments/ocp-server/pkg/code/data/transaction/memory"
	vault_memory_client "github.com/code-payments/ocp-server/pkg/code/data/vault/memory"

	account_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/account/postgres"
	action_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/action/postgres"
	balance_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/balance/postgres"
	currency_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/currency/postgres"
	cvm_ram_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/cvm/ram/postgres"
	cvm_storage_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/cvm/storage/postgres"
	deposit_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/deposit/postgres"
	fulfillment_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/fulfillment/postgres"
	intent_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/intent/postgres"
	messaging_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/messaging/postgres"
	nonce_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/nonce/postgres"
	rendezvous_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/rendezvous/postgres"
	swap_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/swap/postgres"
	timelock_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/timelock/postgres"
	transaction_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/transaction/postgres"
	vault_postgres_client "github.com/code-payments/ocp-server/pkg/code/data/vault/postgres"
)
