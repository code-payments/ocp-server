...
type DatabaseData interface {
	...
	GetAllSwapsByOwnerAndMint(ctx context.Context, owner string, mint string, state swap.State) ([]*swap.Record, error)
...
func (dp *DatabaseProvider) GetAllSwapsByOwnerAndMint(ctx context.Context, owner string, mint string, state swap.State) ([]*swap.Record, error) {
	return dp.swaps.GetAllByOwnerAndMint(ctx, owner, mint, state)
}
